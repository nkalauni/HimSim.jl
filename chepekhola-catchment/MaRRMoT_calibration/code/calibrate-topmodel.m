...
model     = 'm_14_topmodel_7p_2s';                                          % Name of the model function (these can be found in Supporting Material 2)
m = feval(model);
...
% warm-up, and 16 years for calibration, leaving the rest of the dataset for
